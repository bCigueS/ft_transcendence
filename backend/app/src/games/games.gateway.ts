...
import { OnGatewayInit, WebSocketGateway, SubscribeMessage, WebSocketServer, MessageBody, ConnectedSocket } from '@nestjs/websockets';
...
// 	client.on('join', async({ id, lvl, gameRoom }: { id: number, lvl: number, gameRoom?: number }, callback: CallbackInfo) => {
